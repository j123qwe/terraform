...
variable "worker_extra_disk_size" {
  description = "Optional worker disk1 size (set empty string to disable)"
  type        = string
  default     = ""
}

variable "worker_extra_disk_mount_path" {
  description = "Mount path for optional worker disk1 when enabled"
  type        = string
